...
int print_c(va_list args, char *buf, unsigned int *ibuf, int flags, int width, int size)
{
...
int print_s(va_list args, char *buf, unsigned int *ibuf, int flags, int width, int size)
{
...
int print_int(va_list args, char *buf, unsigned int *ibuf, int flags, int width, int size)
{
	long int n;
	unsigned long int num, temp, div = 1;
	int count = 0, len = 0, neg = 0;
...
int print_dec(va_list args, char *buf, unsigned int *ibuf, int flags, int width, int size)
{
	return (print_int(args, buf, ibuf, flags, width, size));
}
